...
// POST ➡ api/categories
categoryRouter.post("/", categoryValidation, runValidation, isLoggedIn, isAdmin, createCategoryHandler);
...
categoryRouter.put("/:slug", categoryValidation, runValidation, isLoggedIn, isAdmin, updateCategoryHandler);
